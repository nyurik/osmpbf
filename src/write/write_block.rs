...
use crate::proto::osmformat::{Node, PrimitiveGroup, Way};
...
use crate::{BlobHeader, DeltaEncoder};
...
impl PrimitiveBlock {
    ...
    pub fn add_node<TTags>(&mut self, id: Option<i64>, tags: TTags, lat: i64, lon: i64)
    where
...
mod tests {
    ...
    fn test_ways() {
        ...
        w.add_way(Some(42), vec![1], vec![], vec![], vec![]);
